  ...
  return (
    <div className="shrink-0 p-5 border-b border-white/5 bg-black/40 backdrop-blur-xl flex flex-col gap-1 relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 relative z-10">
        <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center shadow-[0_8px_32px_rgba(99,102,241,0.15)] flex-shrink-0 transition-transform duration-500 hover:scale-105">
