  ...
  return (
    <div className="px-5 pb-5">
      <div className={`bg-white/[0.02] border border-white/5 rounded-2xl p-5 transition-all duration-700 backdrop-blur-md ${
        isShimmering ? 'shadow-[0_0_30px_rgba(16,185,129,0.15)] border-[var(--holo-cyan)]/30 scale-[1.01]' : 'shadow-sm'
      }`}>
          <div className="flex justify-between items-center mb-4">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[var(--holo-cyan)]/90 flex items-center gap-2">
            ...
            <span className={`text-[12px] font-mono font-bold transition-colors duration-500 ${
              riskAppetite > 75 ? 'text-[var(--holo-magenta)]' : riskAppetite < 25 ? 'text-cyan-400' : 'text-gray-400'
            }`}>
              {riskAppetite}%
            </span>
          </div>
          ...
          <div className="relative py-2">
            <input 
              ...
              className="w-full h-1.5 bg-black/50 rounded-lg appearance-none cursor-pointer border border-white/5 accent-[var(--holo-cyan)] hover:accent-[var(--holo-cyan)] transition-all focus:outline-none" 
            />
          </div>
          ...
          <div className="flex justify-between gap-3 mt-4">
            {[
              ...
              { label: 'Balanced', val: 50, baseColor: 'text-[var(--holo-cyan)]/80', activeBg: 'bg-[var(--holo-cyan)]/15', activeBorder: 'border-[var(--holo-cyan)]/40', glow: 'shadow-[0_0_15px_rgba(16,185,129,0.15)]' },
              { label: 'Aggressive', val: 85, baseColor: 'text-[var(--holo-magenta)]/80', activeBg: 'bg-[var(--holo-magenta)]/15', activeBorder: 'border-[var(--holo-magenta)]/40', glow: 'shadow-[0_0_15px_rgba(244,63,94,0.15)]' }
            ].map(p => {
