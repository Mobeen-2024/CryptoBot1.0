  ...
  return (
    <div className="flex-1 shrink-0 bg-[#0a0a0c]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-5 w-full min-w-[300px] max-w-[360px] flex flex-col text-white shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-rose-500/20 to-orange-500/20 border border-white/10 flex items-center justify-center shadow-[0_4px_20px_rgba(244,63,94,0.15)] shrink-0">
      ...
      <div className="flex flex-col gap-4 relative z-10">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative border border-white/5 rounded-xl bg-black/40 px-3 py-2.5 shadow-inner">
            ...
            <span className="font-mono font-bold text-sm text-indigo-300">{masterEntryPrice.toFixed(4)}</span>
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              placeholder="0.00"
              className="w-full bg-black/60 border border-white/10 text-white font-mono font-bold text-sm rounded-xl pl-6 pr-3 py-2.5 outline-none focus:border-rose-500/50 transition-colors shadow-inner"
            />
          </div>
        </div>

        {/* 3. Mathematical Output Box */}
        <div className="mt-2 bg-rose-500/5 border border-rose-500/20 rounded-xl p-3 flex flex-col gap-2">
          <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-rose-400 mb-1">
          ...
          <div className="flex justify-between items-center text-sm font-bold">
            <span className="text-rose-400">Calculated SL</span>
            <span className="font-mono text-rose-300">${suggestedSL.toFixed(4)}</span>
          </div>
          <div className="flex justify-between items-center text-sm font-bold">
            <span className="text-emerald-400">Calculated TP</span>
            <span className="font-mono text-emerald-300">${suggestedTP.toFixed(4)}</span>
          </div>
        </div>
